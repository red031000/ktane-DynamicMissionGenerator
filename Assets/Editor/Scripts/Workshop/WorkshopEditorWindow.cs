...
public class WorkshopEditorWindow : EditorWindow
{
    ...
    protected void OnGUI()
    {
        ...
        else
        {
			...
			{
				EditorGUILayout.HelpBox("Your mod uses the Harmony library. This means it won't work without the Tweaks mod, so on the Workshop, please either add the Tweaks mod as a dependency or mention it in the description!", MessageType.Warning);
			}
